...
const PrintView = ({ data, projectStage }) => {
  return (
    <div className="hidden print:block w-full max-w-[1200px] mx-auto text-black">
      {/* ATS Breakdown */}
      <div className="break-after-page min-h-screen pt-12 w-full">
      ...
      <div className="break-after-page min-h-screen pt-12 w-full">
        ...
        <div className="grid grid-cols-2 gap-8">
          {projectStage?.projectList?.map((proj, i) => (
            <div key={i} className="bg-slate-50 border border-slate-200 rounded-2xl p-8 shadow-sm flex flex-col h-full">
      ...
      <div className="min-h-screen pt-12 w-full">
        ...
        <div className="grid grid-cols-2 gap-16">
          <div>
            ...
            <div className="space-y-10 relative pl-6 border-l-4 border-slate-200">
          ...
          <div>
            ...
            <div className="space-y-6">
              {data.liveJobs && data.liveJobs.length > 0 ? data.liveJobs.slice(0, 6).map((job, i) => (
                <div key={i} className="block bg-slate-50 border border-slate-200 rounded-xl p-6 shadow-sm">
